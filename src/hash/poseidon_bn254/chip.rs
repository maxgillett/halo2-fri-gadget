/// Modified from the Axiom halo2-base repo (originally taken from
/// https://github.com/scroll-tech/halo2-snark-aggregator/tree/main/halo2-snark-aggregator-api/src/hash)
    ...
    PoseidonChip<'_, F, A, T, RATE>
{
    ...
    fn permutation<'v>(
        ...
        ctx: &mut Context<'_, F>,
        chip: &A,
        state: &mut PoseidonState<'v, F, A, T, RATE>,
