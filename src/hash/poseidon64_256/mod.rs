...
pub struct Poseidon64_256<F: Field64> {
    _marker: PhantomData<F>,
}

impl<F: Field64> Poseidon64_256<F> {
    pub const WIDTH: usize = WIDTH;
    pub const N_ROUNDS: usize = N_ROUNDS;
    pub const SPONGE_RATE: usize = SPONGE_RATE;
    pub const SPONGE_CAPACITY: usize = SPONGE_CAPACITY;
    ...
    pub const MDS_MATRIX_CIRC: [u64; WIDTH] = MDS_MATRIX_CIRC;
    pub const MDS_MATRIX_DIAG: [u64; WIDTH] = MDS_MATRIX_DIAG;
    ...
    // the paper.
    pub const FAST_PARTIAL_FIRST_ROUND_CONSTANT: [u64; WIDTH] = FAST_PARTIAL_FIRST_ROUND_CONSTANT;
    pub const FAST_PARTIAL_ROUND_CONSTANTS: [u64; N_PARTIAL_ROUNDS] = FAST_PARTIAL_ROUND_CONSTANTS;
    pub const FAST_PARTIAL_ROUND_VS: [[u64; WIDTH - 1]; N_PARTIAL_ROUNDS] = FAST_PARTIAL_ROUND_VS;
    pub const FAST_PARTIAL_ROUND_W_HATS: [[u64; WIDTH - 1]; N_PARTIAL_ROUNDS] =
        FAST_PARTIAL_ROUND_W_HATS;
